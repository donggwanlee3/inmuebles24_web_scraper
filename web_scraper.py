...
Original file is located at
    https://colab.research.google.com/drive/1LfBxMBqK57YJ-ZyxrlXFdT59AZ_FSpLK
"""
...
async def process_listing(url, browser):
    ...
    if result_dictionary != None:
        ...
        if result_dictionary["is_building"]:
            ...
            with open('Building_Properties.csv', 'w', newline='', encoding='utf-8') as f:
            ...
            with open('Unit_Properties.csv', 'w', newline='', encoding='utf-8') as f:
